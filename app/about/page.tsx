      ...
      */}
      ...
      <FadeIn>
        <section className="space-y-4">
          ...
          <p className="text-base leading-relaxed text-neutral-400 tracking-[-0.01em]">
            <strong className="text-neutral-200">{NEWSLETTER.name}</strong> es lo que escribo cada martes sobre eso: qué está pasando de verdad con la IA adentro de las empresas grandes, sin humo y sin hype.
          </p>
          <p className="text-base leading-relaxed text-neutral-400 tracking-[-0.01em]">
            <strong className="text-neutral-200">Above Average</strong> es el sistema al que fui llegando por el camino, y el libro en el que lo estoy escribiendo. Tres capas: el Kernel biológico (cuerpo en forma), las extensiones técnicas (IA, SAP, arquitectura) y la soberanía cognitiva (juicio propio que ninguna IA puede reemplazar). La v1.0 está publicada y es gratuita, en <a href="/recursos/above-average-os" className="text-accent underline underline-offset-4 decoration-accent/40 hover:decoration-accent transition-colors">Recursos</a>.
          </p>
        </section>
      </FadeIn>
